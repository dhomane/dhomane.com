...
var Dropdown = /** @class */ (function (_super) {
    ...
    Dropdown.prototype.render = function () {
        ...
        return (react_1.default.createElement("div", { className: wrapperClass, onKeyDown: this.onKeyDown, ref: this.container },
            react_1.default.createElement("button", { "aria-label": ariaLabel, "aria-describedby": ariaDescribedBy, "aria-labelledby": ariaLabelledBy, className: dropdownButtonClass, disabled: disabled, id: id, onClick: this.onDropdownClick, onKeyDown: this.onDropdownClick, ref: this.button, type: "button" },
